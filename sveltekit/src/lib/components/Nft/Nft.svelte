<script lang="ts">
	...
	import { shortcodeOpenSky } from '@kredeum/sveltekit/src/lib/helpers//shortcode';
	import {
		nftOwner,
		nftMarketable,
		nftRoyaltyAccount,
		...
		nftPrice,
		nftPriceValid
	} from '@kredeum/common/lib/nft/nft';
	...
	import {
		...
		sorageLinkToUri
	} from '@kredeum/common/lib/nft/storage/storage';
			...
			<div class="kre-action-buttons {mode == 'detail' ? '' : 'kre-web-buttons'}">
				...
				{:else}
					<div class="overflow-ellipsis kre-description-link">
						<strong>
							<a
								href={getDappUrl(chainId, $nft)}
								target="_blank"
								rel="noreferrer"
								class="kre-blue-link">{$nft.name} #{tokenID}</a
							>
						</strong>
					</div>
				{/if}
						...
						<li>
							...
							<div class="flex kre-flex-align-center" title="Token ID #{tokenID}">
								<div class="overflow-ellipsis">
									<strong>
										<a href={getDappUrl(chainId, $nft)} class="kre-blue-link">#{tokenID}</a></strong
									>
								</div>
							...
							{#if nftPrice($nft).gt(0)}
								<li>
									...
									<div class="flex kre-flex-align-center">
										<div class="overflow-ellipsis">
											<span
												class={nftPriceValid($nft) ? '' : 'c-red'}
												title={utils.formatEther(nftPrice($nft))}
											>
					...
					<ul class="steps">
						...
						{#if nftMarketable($nft)}
							<li>
								...
								<div class="flex kre-buy-widget-textarea">
									<a
										...
										on:click|preventDefault={(evt) =>
											copyShortcodeToClipboard(evt, 'WordPress NFT shortcode')}
										class="btn btn-small btn-outline"
										href="."
									...
									<a
										...
										on:click|preventDefault={(evt) =>
											copyShortcodeToClipboard(evt, 'WordPress Collection shortcode')}
										class="btn btn-small btn-outline"
										href="."
								...
								<div class="flex kre-buy-widget-textarea">
									<textarea value={openSkyShortcode} />
								</div>
							</li>
							<li>
								<div class="flex">
								...
								<div class="flex kre-buy-widget-textarea">
									<a
										...
										on:click|preventDefault={(evt) =>
											copyWidgetToClipboard(evt, 'WordPress NFT shortcode')}
										class="btn btn-small btn-outline"
										href="."
									...
									<a
										...
										on:click|preventDefault={(evt) =>
											copyWidgetToClipboard(evt, 'WordPress Collection shortcode')}
										class="btn btn-small btn-outline"
										href="."
