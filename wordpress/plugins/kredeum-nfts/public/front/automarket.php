...
/**
 * Enqueue kredeum's js and styles if the kredeum_nft_automarket shortcode is being used.
 */
add_action(
	'wp_enqueue_scripts',
	function () {
		global $post;
		if ( is_a( $post, 'WP_Post' ) && has_shortcode( $post->post_content, 'kredeum_nft_automarket' ) ) {
