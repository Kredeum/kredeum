...
export interface IOpenNFTsV0Interface extends utils.Interface {
  contractName: "IOpenNFTsV0";
  functions: {
...
export interface IOpenNFTsV0 extends BaseContract {
  contractName: "IOpenNFTsV0";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOpenNFTsV0Interface;
