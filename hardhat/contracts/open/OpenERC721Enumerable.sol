...
// https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC721/extensions/ERC721Enumerable.sol
...
abstract contract OpenERC721Enumerable is IERC721Enumerable, OpenERC721 {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < OpenERC721.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < OpenERC721Enumerable.totalSupply(), "ERC721Enumerable: global index out of bounds");
