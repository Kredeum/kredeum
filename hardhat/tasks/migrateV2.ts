...
task("migrateV2", "Migrate NFTsFactory implementations to NFTsFactoryV2")
  .addFlag("go", "Really do it ! Migrate all NFTsFactory implementations to NFTsFactoryV2")
  .setAction(async ({ go }, { deployments, ethers, getChainId }) => {
