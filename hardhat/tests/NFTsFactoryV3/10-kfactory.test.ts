...
describe.skip("10 Clone Factory contract", function () {
  ...
  beforeEach(async () => {
    ...
    if ((await ethers.provider.getNetwork()).chainId == 31337) {
      await deployments.fixture(["NFTsFactoryV3", "OpenNFTsV1", "OpenNFTsV2", "OpenNFTsV4"]);
    }
    nftsFactoryV3 = (await ethers.getContract("NFTsFactoryV3")) as unknown as NFTsFactoryV3;
