...
import { mainnet, gnosis, scroll, zora, polygon, bsc, arbitrum, optimism, sepolia } from "viem/chains";
import chains from "@kredeum/providers/src/chains";
import { anvil } from "@kredeum/providers/src/anvil";

import { type NetworkType, type NftType } from "../common/types";
import { strUpFirst } from "../common/config";

const _chains: Chain[] = [mainnet, gnosis, scroll, zora, polygon, bsc, arbitrum, optimism, sepolia, anvil];
