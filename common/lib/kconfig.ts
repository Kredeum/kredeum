...
/////////////////////////////////////////////////////////////////////////////////////////////////////
// Swarm uri : swarm://1fa18cf1aaee4727ecc266a86f1ef0f98b14771c7814d8cfb850a4b1c6d1359f
// => gateway link <a href="https://api.gateway.ethswarm.org/bzz/1fa18cf1aaee4727ecc266a86f1ef0f98b14771c7814d8cfb850a4b1c6d1359f" target="_blank">1fa1...d1359f</a>
/////////////////////////////////////////////////////////////////////////////////////////////////////
const swarmGatewayLink = (swarm: string): string => urlToLink(swarmGatewayUrl(swarm), textShort(swarm));
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ipfs or swarm uri
// => gateway link for ipfs or swarm
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const storageGatewayLink = (storageURI: string) =>
  storageURI.startsWith("ipfs://")
    ? ipfsGatewayLink(storageURI)
    : storageURI.startsWith("swarm://")
      ? swarmGatewayLink(storageURI)
      : "";
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
