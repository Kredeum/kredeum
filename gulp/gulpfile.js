...
// Clean assets
function clean() {
  return del(["../dapp/", ".../wordpress/kredeum-nfts/lib/"], { force: true });
}
...
function fonts() {
  return gulp.src(["./fonts/**/*"]).pipe(gulp.dest("../dapp/assets/fonts/")).pipe(gulp.dest("../wordpress/kredeum-nfts/lib/fonts/"));
}
