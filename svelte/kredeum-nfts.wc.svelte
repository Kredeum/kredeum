 ...
 */
  ...
  select {
    ...
    background: #fff url(../images/chevron.svg) no-repeat 90% 50%;
    color: #1e1e43;
    border-radius: 360px;
    cursor: pointer;
  }
  select.custom {
    color: #606b86;
    border: 1px solid rgba(96, 107, 134, 0.3);
    border-radius: 6px;
    width: 100%;
  ...
  .btn-mint:hover {
    background: rgba(58, 207, 110, 0.2);
  }
  .btn-sell {
    color: #fff;
    background: #3acf6e;
  ...
  .box-file {
    background: rgba(96, 107, 134, 0.1);
    padding: 15px;
    border-radius: 6px;
  }
  .box-file,
  ...
  .box-fields .box-field:checked + label {
    background: #1e1e43;
    color: #fff;
  }
  .field,
  ...
  .tag-eth {
    color: #2e80dd;
    background: rgba(46, 128, 221, 0.1);
  }
  .tag-polygon {
    color: #9e2195;
    background: rgba(158, 33, 149, 0.1);
  }
  .tag-marketplace {
    color: #606b86;
    border: 1px solid rgba(96, 107, 134, 0.3);
  ...
  .table .table-row:not(.table-head) > div:not(.no-bg) {
    background: #fff;
  }
  .table .table-row:not(.table-head) > div:not(.no-bg):first-child {
    border-radius: 6px 0 0 6px;
  }
  .table .table-row:not(.table-head) > div:not(.no-bg):last-child {
  ...
  .table .table-col-full input[type="checkbox"] {
    display: none;
  }
  .table .table-col-full label {
    position: absolute;
    right: 15px;
    top: 50%;
  ...
  .table .table-col:not(.table-col-full) {
    display: table-cell;
    vertical-align: top;
    padding: 15px 5px 15px 15px;
    max-width: 0;
  }
  .table .table-col:not(.table-col-full) .table-col-content {
    text-overflow: ellipsis;
    white-space: nowrap;
    overflow: hidden;
  }
  .table .table-col:not(.table-col-full):nth-child(2) .table-col-content,
  .table .table-col:not(.table-col-full):nth-child(3) .table-col-content {
    padding-top: 10px;
  }
  .table .table-col:not(.table-col-full):nth-child(4) .table-col-content {
    padding-top: 5px;
  }
  .table .table-col:not(.table-col-full):first-child {
    width: 20%;
  }
  .table .table-col:not(.table-col-full):nth-child(2) {
    width: 60%;
  }
  .table .table-col:not(.table-col-full):nth-child(3),
  .table .table-col:not(.table-col-full):nth-child(4) {
    width: 10%;
  }
  .table .table-head .label {
    padding-left: 15px;
  }
  ...
  * {
  ...
  main {
    background: url(../images/bg-dapp.svg) no-repeat center -200px;
  ...
  main #search-top button[type="submit"] i {
    font-size: 20px;
  }
  main .content h1 {
    margin: 0;
  ...
  main .content .col-filters .box .box-section:not(:last-child) {
    border-bottom: 1px solid rgba(30, 30, 67, 0.1);
  }
  main .content .table {
    margin-top: -10px;
  }
  main .content .table .table-head .label {
    margin-bottom: 10px;
  }
  ...
  main .content .table .media i {
    color: #fff;
    display: inline-block;
  }
  main .content .table .media-video {
    background: #ce2828;
  }
  main .content .table .media-song {
    background: #f58755;
  }
  main .content .table .media img {
    -o-object-fit: cover;
    object-fit: cover;
    width: 100%;
    height: 100%;
  }
  main .content .table .more-button {
    width: 40px;
    height: 40px;
    line-height: 40px;
  ...
  main .content .table .more-button i {
    color: #606b86;
    transition: all 0.3s ease-in-out;
    transform: rotate(-180deg);
  }
  main .content .table .table-drop {
    position: relative;
  }
  ...
  main .content .table .detail ul {
    margin: 0 0 0 15px;
    padding: 0;
  }
  main .content .table .detail ul li span {
    opacity: 0.7;
  }
  main .content .table .detail ul li:not(:last-child) {
    margin-bottom: 10px;
  }
  main .content .table .closed .more-button i {
    transform: rotate(0deg);
  }
  main .content .table .closed .detail {
    overflow: hidden;
    opacity: 0;
    visibility: hidden;
  }
  ...
  @media screen and (max-width: 991px) {
    ...
    nav .menu input:checked ~ label span:first-child {
      top: 10px;
      right: 0;
      transform: rotate(45deg);
    }
    nav .menu input:checked ~ label span:nth-child(2) {
      opacity: 0;
    }
    nav .menu input:checked ~ label span:nth-child(3) {
      top: 10px;
      right: 0;
      transform: rotate(-45deg);
    }
    nav .menu input:checked ~ label + .nav {
    ...
    main .col-filters > .label {
      margin-top: 20px;
    }
    main .col-filters .box {
      display: none;
    }
    main .col-filters .box .box-section {
      padding: 30px 0 22px;
    }
    .modal-window {
      overflow-y: auto;
  ...
  @media screen and (min-width: 992px) {
    nav {
      flex: 0 0 auto;
      width: 130px;
      background: #1e1e43 url(../images/bg-dapp.svg) no-repeat top;
