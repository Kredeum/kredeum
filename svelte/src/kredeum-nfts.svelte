...
<div id="kredeum-nfts">
  <nav class="nav-krd">
    <div class="logo">
      <a href="https://www.kredeum.com" target="_blank" alt="Kredeum website" title="Kredeum website"><img src="assets/images/logo-kredeum.svg" alt="Logo Kredeum" /></a>
    </div>
    ...
    <a class="discord-link" href="https://discord.gg/Vz5AyU2Nfx" target="_blank" alt="Discord Kredeum" title="Discord Kredeum"><i class="icon-discord"></i></a>
  </nav>
      ...
      <section class="content">
        <header>
          ...
          {#if $owner && getCreate($chainId)}
            <a href="#create" class="btn btn-default" title="Mint"><i class="fas fa-plus fa-left"></i>Mint</a>
          {/if}
          ...
          <div class="row alignbottom">
            ...
            <div class="col col-sm-3">
              {#if $owner && collection && getNftsFactory($chainId)}
                <button class="clear" on:click="{() => refreshNFTs(true)}" title="      {refreshing ? 'Refreshing NFTs...' : 'Refresh NFTs from this Collection'}">
        ...
        <KredeumListNfts collection="{collection}" refreshing bind:refreshNFTs platform="{platform}" />
      </section>
    </div>
  </main>
