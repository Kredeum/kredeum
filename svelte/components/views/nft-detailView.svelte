...
<h2 class="m-b-20 return">
    <i class="fa fa-arrow-left fa-left"></i><a href="." class="link">Return to collection</a>
</h2>
...
<div class="row grid-detail-krd">
    ...
    <div class="col col-xs-12 col-sm-8 col-md-9">
        <div class="card-krd">
            <h3>MaticPunk #8373 <a class="info-button" href="" target="_blank"><i class="fas fa-info-circle"></i></a></h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ac felis a sapien lobortis finibus nec vel lectus. Integer arcu est, laoreet ut dui ac, cursus suscipit metus.</p>
            ...
            <div class="p-t-40 p-b-40 grid-buttons">
                <a href="#schortcodes" class="btn btn-small btn-outline" title="Get shortcode"><i class="fa fa-code"></i><span>Get shortcode</span></a>
                <a href="#gift" class="btn btn-small btn-outline" title="Make a gift"><i class="fa fa-gift"></i><span>Make a gift</span></a>
...
<div id="schortcodes" class="modal-window">
    <div>
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="titre">
                    <i class="fas fa-code fa-left c-green"></i>
                    Shortcodes
                </div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ac felis a sapien lobortis finibus nec vel lectus.</p>
...
<div id="gift" class="modal-window">
    <div>
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="titre">
                    <i class="fas fa-gift fa-left c-green"></i>
                    Make a gift
                </div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ac felis a sapien lobortis finibus nec vel lectus.</p>
