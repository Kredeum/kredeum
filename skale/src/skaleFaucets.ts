...
type ScaleFaucets = {
  [key: number]: { proofOfWork: Address; threshold: number; explorer: string };
};

//  From : https://github.com/Dirt-Road-Development/sfuel-station/blob/main/app/config/chains.ts
