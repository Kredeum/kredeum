...
const networksKRE = [
  {
    ...
    blockExplorerUrls: matic.blockExplorerUrls,
    rpcUrls: [`${matic.rpcUrls[0]}/${MATICVIGIL_API_KEY}`],
  ...
  },
  {
    ...
    blockExplorerUrls: mumbai.blockExplorerUrls,
    rpcUrls: [`${mumbai.rpcUrls[0]}/${MATICVIGIL_API_KEY}`],
