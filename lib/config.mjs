...
const chainIds = "0x1,0x4,0x38,0x89,0x13881,0x8376940b1db0";
const chainIdDefault = "0x1";

function getNetwork(_chainId) {
  return configNetworks.find((network) => Number(network.chainId) === Number(_chainId));
}
...
export { configNetworks, configContracts, abis, getProvider, getNetwork, chainIds, chainIdDefault };
