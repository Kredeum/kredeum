...
class OpenNfts {
  ...
  supportsSubgraph() {
    console.log("this.subgraphUrl", this.subgraphUrl);
  ...
  async listTokens(_owner) {
    ...
    if (_owner) {
      ...
      if (this.subgraphUrl) tokens = await this.listTokensFromTheGraph(_owner);
        ...
        tokens = await this.listTokensFromContract(_owner);
        ...
        console.log("this.supportsEnumerable", this.supportsEnumerable);
        console.log("this.subgraphUrl", this.subgraphUrl);
