import type { NetworkType, CollectionType } from "@lib/common/types";
import type { TransactionResponse } from "@ethersproject/abstract-provider";
import type { OpenNFTsV4 } from "@soltypes/contracts";

import { nftList } from "@lib/nft/nft-list";
...
describe("42 List OpenNFTsV4 lib", function () {
  beforeEach(async () => {
    ...
    await ((await openNFTsV4["mint(address,string)"](artistAddress, jsonURI, txOptions)) as TransactionResponse).wait();
